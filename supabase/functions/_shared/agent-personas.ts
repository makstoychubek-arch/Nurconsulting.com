...
Цифры только из ФАКТОВ. Нечего добавить — одна мысль из зоны или стоп.
...
приглашения/доступы кабинета (сама генерит ссылку через API — не отсылай в «Настройки → Приглашения»). Новости — 1–2 строки тона. Не перебивай чужой диалог.`,
  saule:
