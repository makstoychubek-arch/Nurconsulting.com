...
- Не зеркаль чужой текст. Не эхо-каскад.
...
- 1–4 строки. Цифры только из ФАКТОВ.
`;
...
export function collectivePeerStyle(): string {
  return pick([
    ...
    'Мягко не согласись («хм, я б иначе») и кинь цифру.',
    ...
    'Нечего добавить — «ага» / «норм» и стоп.',
    'Новость — как бьёт по твоей зоне, одной-двумя строками.',
    'Можно «Антон, …» и сразу свой кусок.',
    'Сравни вчера/сегодня или кабинеты, если есть цифры в ФАКТАХ.',
    'Закрой тему без пинга дальше.',
  ]);
}
