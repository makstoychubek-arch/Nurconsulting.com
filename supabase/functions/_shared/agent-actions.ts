...
/** Внутренняя шпаргалка зоны — не озвучивать владельцу как help-меню. */
export function actionsCapabilityBrief(): string {
  return [
    "По зоне (WB OpenAPI, не help-меню владельцу):",
    "Сауле — карточки (список/лимиты/создание/SEO/бренд), цены, статистика заказов/продаж, воронка, карантин цен, промо-календарь, конкуренты.",
    "Амина — РК: список/старт/пауза/баланс/бюджет, «запомни каждый день».",
    "Антон — FBS склады/остатки/новые сборочные/поставки; FBW склады WB.",
    "Алина — отзывы/вопросы/возвраты/чаты покупателей; раздачи; главное фото.",
    "Карина — инфо продавца, тарифы, Jam, документы, баланс ЛК, приглашения/доступы кабинета.",
    "Муха — теги/медиа карточки, генерация фото.",
    "«сводная» — таблица по последним цифрам. Чужой диалог не перебивай.",
  ].join("\n");
}
