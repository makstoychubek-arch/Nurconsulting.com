...
function buildScripts() {
    ...
    const scripts = ['dashboard-charts.js', 'rnp-module.js', 'wb-formulas.js', 'evidence-report.js', 'ads-command-center.js', 'goods-catalog.js', 'content-factory.js', 'nr-wow.js', 'dash-cabinet-plans.js'];
    const map = {};
