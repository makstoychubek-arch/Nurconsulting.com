...
- `завтра` / `через неделю` / `через 2 недели` → на WB шаблон «Здравствуйте, этот товар будет в наличии …»
...
После вашего реплая Карина ничего не пишет — только ставит ❤ на сообщение, если ответ ушёл на WB. Без ссылок и без «готово». Если сердечка нет — ответ на WB ещё не ушёл.
