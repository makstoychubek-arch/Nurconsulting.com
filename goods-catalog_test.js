...
assert.equal(C.SNAPSHOT_HOUR_BISHKEK, 11);
assert.equal(C.canWriteDailySnapshot(new Date('2026-09-11T04:59:00Z')), false, 'before 11:00 Bishkek the day is not locked');
assert.equal(C.canWriteDailySnapshot(new Date('2026-09-11T05:00:00Z')), true, 'from 11:00 Bishkek the screen may fill a missed day');
